...
@NgModule({
  ...
  imports: [
    ...
    NgxAuthFirebaseUIModule.forRoot(
                ...
                {
                  authMethod: 'popup', //'popup' or 'redirect'. Method to authenticate users. Default - popup. Redirect is recomended for mobile devices.Redirect is recomended for mobile devices.
